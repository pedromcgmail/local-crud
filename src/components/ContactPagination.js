...
const Pagination = ({pages, setCurrentPage, currentContacts, sortedContacts}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentContacts.length}</b> out of <b>{sortedContacts.length}</b> entries</div>
